...
- Do not hard-wrap prose. Let the client wrap it.
- Keep copy-paste-ready shell input within 75 columns.
...
- In shell blocks, never rely on visual wrapping or split
