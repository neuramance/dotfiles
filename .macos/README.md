...
| Homebrew | 146 formulae and 4 casks after removing `glab`; `~/.Brewfile` records 36 formulae, 4 casks, 2 taps, and 11 Mac App Store apps. | None. |
